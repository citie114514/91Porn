...
页面伪装成经典老式「成人网站」免责声明风格（黑底、灰色警告框、红/蓝下划线链接），朋友点击进入并尝试播放视频时，会自动跳转到 / 播放：
...
- 🎭 复古老式网站免责声明风格（黑底、灰警告框、红/蓝下划线链接，仅界面，**无任何不良内容**）
...
- ✅ 弹窗在移动端小屏下不再溢出
- ✅ 主页改为经典老式网站免责声明风格（黑底 + 灰警告框 + 红/蓝链接 + RTA 标记），移除粒子背景与居中弹窗
