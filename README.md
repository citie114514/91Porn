# 💀 91Bait — 经典 91 风格钓鱼整蛊页面

> 假装成人网站，点开却播放你自己上传的视频（比如经典骷髅跳舞）🕺

一个纯前端整蛊恶作剧页面。**无任何真实色情内容、无恶意代码、无追踪、无广告。**  
页面伪装成经典老式「成人网站」免责声明风格（浅色、顶部警告图、红/蓝下划线链接），朋友点击进入并确认年龄后，会自动播放：

- 🎬 **你自定义的视频** —— 往 GitHub Release 里上传什么，就播什么（骷髅跳舞、鬼畜素材……随你发挥）
...
- 🎭 复古老式网站免责声明风格（浅色、警告图、红/蓝下划线链接，仅界面，**无任何不良内容**）
- 🎬 点击「我已满 18 岁」→ 播放 Release 中的自定义视频
- 🎞️ 原生 HTML5 `<video>` 播放器，自动加载 GitHub Release 视频，内容完全由你决定
- 📜 经典繁中/英文警告文案 + RTA® 标记，钓鱼感拉满
- 📱 移动端 / 桌面端自适应
...
- ✅ 弹窗在移动端小屏下不再溢出
- ✅ 主页改为经典老式网站免责声明风格（浅色 + 警告图 + 红/蓝链接 + RTA 标记），移除粒子背景与居中弹窗
